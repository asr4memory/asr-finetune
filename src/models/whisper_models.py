...
def get_whisper_models_from_hub(model_type,target_language,return_timestamps=False, load_in_8bit=False):
    """
    ...
    Returns:
        Tuple: (model, feature_extractor, tokenizer, processor)
    """
    print(f"Loading model from hub: {model_type}")
...
def get_whisper_models(model_type,
    ...
    if local:
        ...
        model, feature_extractor, tokenizer, processor = get_whisper_models_from_hub(model_type,
                                                                                  target_language,
                                                                                  return_timestamps=return_timestamps,
                                                                                  load_in_8bit=load_in_8bit,
                                                                                  )
